...
- **Open any session** to see every visitor message and the AI's response in full
- **Delete a conversation** when you no longer need it (uses a confirmation prompt)
- **Identify patterns** — repeated questions signal missing or unclear content

<Note>
Keyword search and feedback-rating filters aren't built into the Conversations tab today. To surface low-satisfaction sessions or specific topics, scan chronologically or use the [Analytics](/managing/analytics) tab to first locate the message hashes that flagged with thumbs-down feedback.
</Note>
...
<Steps>
  ...
  <Step title="Scan recent sessions">
    Conversations are listed newest-first. Click any session to expand the full transcript on the right.
  </Step>
