...
| OneDrive | Cloud | Connect Microsoft account and select files |
| SharePoint | Building | Connect Microsoft account, pick a site → drive → files |
| Zendesk Help Center | LifeBuoy | Enter the Help Center URL |
| GitBook | Book | Enter the GitBook space URL |
