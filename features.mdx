...
<CardGroup cols={2}>
  ...
  <Card title="Cloud Storage Connectors" icon="cloud">
    OAuth pickers for [Google Drive](/integrations/google-drive), [Notion](/integrations/notion), and [Dropbox](/integrations/dropbox). [OneDrive](/integrations/onedrive) and [SharePoint](/integrations/sharepoint) Microsoft Graph integration is built — picker UI rolling out shortly (contact support to enable manually).
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Instructions">
    System-prompt-level rules, tone guidelines, safety constraints, and temperature control (0.0–1.0).
  </Card>
  ...
  <Card title="13 Built-in Personas">
    Default, Default (Classic), Neutral, Professional / Formal, Informative, Engaging, Inspirational, Playful / Funny, Sales Expert, Consultant, Problem Solver, Urgent & Action-Oriented, Empathetic Support.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="5 Trigger Timing Modes">
    At chat start, after N messages, before escalation, on intent keywords (up to 30), or on a no-answer.
  </Card>
  <Card title="10 Industry Templates" href="/deployment/lead-capture#set-up-the-lead-form">
    One-click presets for Dental, HVAC, Legal, Real Estate, Auto, Healthcare, SaaS, E-commerce, Consulting + a Reset blank.
  </Card>
  <Card title="Country-Code Auto-Detect">
    24 timezone-to-country mappings prefill the right phone dial code so visitors don't fish through a dropdown.
  </Card>
...
<Note>
Team workspaces are **coming soon**. Per-plan seat counts (1 / 1 / 4 / 10) are reserved in the billing system today; the invite UX, role-based access, and member management ship in a follow-up release. See [Team Members](/managing/team-members) for the planned scope.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Direct-Link Chat URL">
    Every chatbot has a public direct-link URL (`/embed/<id>`) you can share without embedding it.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Free Plan — No Credit Card">
    Start on the Free plan with 1 chatbot, 200 messages / month, and 30 pages — no card required.
  </Card>
  ...
  <Card title="Razorpay Payments (INR)">
    Monthly subscriptions billed in INR via Razorpay. Enterprise pricing available on request.
  </Card>
...
<CardGroup cols={2}>
  <Card title="6 Chatbot Templates">
    Start from a pre-built template — Customer Support, Sales Assistant, Technical Help Desk, Education / Onboarding, Enterprise / B2B, or FAQ Bot.
  </Card>
