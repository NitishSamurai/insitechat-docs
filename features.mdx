...
<CardGroup cols={2}>
  ...
  <Card title="Cloud Storage Connectors" icon="cloud">
    [Google Drive](/integrations/google-drive), [Notion](/integrations/notion), [Dropbox](/integrations/dropbox), [OneDrive](/integrations/onedrive), and [SharePoint](/integrations/sharepoint) pickers with OAuth.
  </Card>
