...
<CardGroup cols={2}>
  ...
  <Card title="Platforms" icon="puzzle-piece">
    [WordPress](/integrations/wordpress), [Shopify](/integrations/shopify), [Telegram](/integrations/telegram), [Slack](/integrations/slack), [Zapier](/integrations/zapier), [HubSpot](/integrations/hubspot).
  </Card>
