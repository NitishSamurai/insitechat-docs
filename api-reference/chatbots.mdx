---
title: "Chatbots API — List & Retrieve"
sidebarTitle: "Chatbots"
description: "List your InsiteChat chatbots and retrieve a single chatbot's details via the REST API. Two read-only endpoints for programmatic chatbot inventory."
author: "InsiteChat"
