...
description: "Programmatically manage chatbots, list sources, send chat messages, and receive webhook events using the InsiteChat REST API. Bearer-token auth, JSON over HTTPS."
author: "InsiteChat"
