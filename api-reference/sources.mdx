---
title: "Sources API — Manage Training Content"
sidebarTitle: "Sources"
description: "List every active training source on an InsiteChat chatbot via the REST API — websites, files, Google Drive folders, Notion pages, and more. Build sync dashboards and audit content."
author: "InsiteChat"
