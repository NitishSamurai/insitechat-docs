...
description: "Authenticate to the InsiteChat REST API using Bearer tokens. Create, list, and revoke API keys from the dashboard. Keys grant access to all chatbots you own."
author: "InsiteChat"
