...
<CardGroup cols={3}>
  ...
  <Card title="Lead Capture & Management" icon="users" href="/deployment/lead-capture">
    Lead forms, status tracking, tags, and bulk actions.
  </Card>
  <Card title="Smart Handoff & Reply from Dashboard" icon="headset" href="/deployment/human-support">
    Multilingual intent detection, escalation, and reply from the InsiteChat dashboard across web, WhatsApp, and Telegram.
  </Card>
</CardGroup>
