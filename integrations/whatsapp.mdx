...
<Note>
WhatsApp is available on the **Growth**, **Scale**, and **Enterprise** plans. Free and Starter plans show an upgrade prompt.
</Note>
...
1. **Literal keyword pre-filter** — fast and free. Catches "talk to a human", "speak to a human", "speak to someone", "human please", "speak to an agent", "real person", "live agent", "connect me to a human", "connect me to an agent".
...
3. Your reply arrives on WhatsApp from your business number — visitors see whatever sender name you've configured for that number in Meta WhatsApp Business Manager (the InsiteChat dashboard does not surface individual agent names to the visitor)
