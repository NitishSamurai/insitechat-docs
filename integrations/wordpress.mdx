...
<Steps>
  <Step title="Download the Plugin">
    In your InsiteChat dashboard, open your chatbot → **Embed** → **Install** tab. Scroll to the **WordPress Plugin** card and click **Download .zip**. The file is `insitechat.zip`.
  </Step>
  ...
  <Step title="Configure">
    ...
    - **Chatbot ID** — copy it from the **Chatbot ID** card at the top of your InsiteChat dashboard's Embed → Install tab
...
2. Open your chatbot → **Embed** → **Install** tab
3. The **Chatbot ID** card sits at the top of the Install tab. Click **Copy** (the ID is a UUID like `xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx`)
