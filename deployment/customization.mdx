...
Pick the personality that best matches how your brand should sound. We ship **13 built-in personas** plus a **Custom** option where you write your own instructions.

| Persona | Tone |
|---------|------|
| **Default** | Helpful, balanced — works for most use cases |
| **Default (Classic)** | The original InsiteChat tone, kept for parity with older bots |
| **Neutral** | Plain, factual, no flourish |
| **Professional / Formal** | Buttoned-up, business-appropriate |
| **Informative** | Detailed, explanatory, teaching-style |
| **Engaging** | Warm, conversational, keeps the visitor reading |
| **Inspirational** | Enthusiastic, motivational, uplifting |
| **Playful / Funny** | Light, witty, occasional humor |
| **Sales Expert** | Persuasive, value-driven, closes confidently |
| **Consultant** | Strategic, thoughtful, asks clarifying questions |
| **Problem Solver** | Methodical, troubleshooting-first |
| **Urgent & Action-Oriented** | Direct, action verbs, no fluff |
| **Empathetic Support** | Warm, validating, customer-care voice |
| **Custom** | Write your own personality / instructions |

<Tip>
The persona only adjusts *how* the AI talks — it never changes the answers themselves. Facts always come from your knowledge base.
</Tip>
...
<Steps>
  ...
  <Step title="Save">
    Click **Save Changes**. Starter items appear immediately in your chat widget.
  </Step>
</Steps>
