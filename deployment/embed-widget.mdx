...
<Tabs>
  <Tab title="Script Tag (Recommended)">
    ...
    **Code snippet:**
    ...
    ```html
    <script src="https://insitechat.ai/widget.js" data-chatbot-id="YOUR_CHATBOT_ID"></script>
    ```

    <Note>
    Replace `YOUR_CHATBOT_ID` with your actual Chatbot ID. The **Embed → Install** tab provides this snippet pre-filled with your ID — just copy and paste.
    </Note>
  </Tab>
  ...
  <Tab title="iFrame Embed">
    ...
    <iframe
      ...
      style="position:fixed;bottom:24px;right:24px;width:430px;height:640px;border:1px solid #e5e7eb;border-radius:16px;z-index:2147483647;background:#fff;"
