...
| **Every 3 days** | Scale | Re-crawls every 3 days |

<Note>
You cannot select a frequency higher than your plan allows. A Growth plan user can choose monthly or weekly, but not the every-3-days option. If you downgrade your plan, sources set to a higher frequency will fall back to the plan's maximum.
</Note>
...
**Scale plan:** Every-3-days auto-sync keeps your chatbot tightly aligned with your content. Use bulk sync for immediate updates across all sources.
