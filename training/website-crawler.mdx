...
<Note>
You cannot select a frequency higher than your plan allows. For example, Growth plan users can choose never, monthly, or weekly — but not the every-3-days option (Scale only).
</Note>
