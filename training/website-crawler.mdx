...
| Monthly (every 30 days) | Starter |
| Weekly (every 7 days) | Growth |
| Daily (every 24 hours) | Scale |

<Note>
You cannot select a frequency higher than your plan allows. For example, Growth plan users can choose never, monthly, or weekly — but not the daily option (Scale only).
</Note>
